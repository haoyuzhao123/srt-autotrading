...
data1 = stocksBasicData(6, : ,(day-6:day-1)); %volumn
data2 = stocksBasicData(7, : ,(day-6:day-1)); %money
data3 = stocksBasicData(2, : ,(day-6:day-1)); %close
data1 = squeeze(data1);
data2 = squeeze(data2);
data3 = squeeze(data3);
data1 = data1(:,end);
...
vwap = data2 ./ data1;
temp = alphaPkg.Rank(vwap - data3) ./ alphaPkg.Rank(vwap + data3);
