...
temp1 = ((data2 - data4) - (data3 - data2)) ./ (data2 - data4 + 0.001);

data11 = stocksBasicData(1, : ,(day-9)); %open
data21 = stocksBasicData(2, : ,(day-9)); %close
data31 = stocksBasicData(4, : ,(day-9)); %high
data41 = stocksBasicData(5, : ,(day-9)); %low
temp2 = ((data21 - data41) - (data31 - data21)) ./ (data21 - data41 + 0.001);
