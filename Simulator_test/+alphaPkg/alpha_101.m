...
data1 = stocksBasicData(1, : ,(day-6:day-1)); %open
data2 = stocksBasicData(2, : ,(day-6:day-1)); %close
data3 = stocksBasicData(4, : ,(day-6:day-1)); %high
data4 = stocksBasicData(5, : ,(day-6:day-1)); %low
data1 = squeeze(data1);
data2 = squeeze(data2);
data3 = squeeze(data3);
data4 = squeeze(data4);

temp = (data2 - data1) ./ (data3 - data4 + 0.001);
