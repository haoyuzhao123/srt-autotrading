...
open = stocksBasicData(1, : ,(day-4:day-1)); 
vwap = stocksBasicData(3, : ,(day-4:day-1)); 
close = stocksBasicData(2, : ,(day-4:day-1));
volume = stocksBasicData(6, :, (day-4:day-1));
...
temp1 = alphaPkg.Rank(alphaPkg.ts_max((vwap - close), 3));
temp2 = alphaPkg.Rank(alphaPkg.ts_min((vwap - close), 3));
temp3 = alphaPkg.Rank(temp1 + temp2);
temp4 = alphaPkg.Rank(alphaPkg.delta(volume, 3));
