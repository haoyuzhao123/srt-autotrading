...
% (rank((open - (sum(vwap, 10) / 10))) * (-1 * abs(rank((close - vwap))))), all negative, modified. 
%the code block to load the basic data

open = stocksBasicData(1, : ,(day-1)); 
vwap = stocksBasicData(3, : ,(day-11:day-1)); 
close = stocksBasicData(2, : ,(day-1));
vwap_latter = stocksBasicData(3, :, day-1);
...
temp1 = temp1 / 10.0;
temp2 = open - temp1;
temp3 = alphaPkg.Rank(temp2);
temp4 = alphaPkg.Rank(close - vwap_latter);
temp5 = -abs(temp4);
temp = temp3 .* temp5;
