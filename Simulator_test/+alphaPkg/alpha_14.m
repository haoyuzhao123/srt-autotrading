...
data1 = stocksBasicData(1, : ,(day-11:day-1)); %open
data2 = stocksBasicData(6, : ,(day-11:day-1)); %volumn
data3 = stocksBasicData(9, : ,(day-4:day-1)); %return
data1 = squeeze(data1);
data2 = squeeze(data2);
data3 = squeeze(data3);

temp = (-1 * alphaPkg.Rank(alphaPkg.delta(data3, 3))) .* alphaPkg.Correlation(data1, data2, 10);
