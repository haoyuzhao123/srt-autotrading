...
data1 = stocksBasicData(4, : ,(day-1)); %high
data2 = stocksBasicData(5, : ,(day-1)); %low
data3 = stocksBasicData(2, : ,(day-1)); %close
data4 = stocksBasicData(1, : ,(day-1)); %open

temp = - (data2 - data3) .* (data4 .^ 5) ./ ((data2 - data1) .* (data3 .^ 5));
