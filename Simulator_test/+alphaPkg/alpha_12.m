...
data1 = stocksBasicData(2, : ,(day-3:day-1)); %close
data2 = stocksBasicData(6, : ,(day-3:day-1)); %volumn
data1 = squeeze(data1);
data2 = squeeze(data2);

temp = -sign(alphaPkg.delta(data2,1)) .* alphaPkg.delta(data1,1);
