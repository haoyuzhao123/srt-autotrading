...
data1 = stocksBasicData(4, : ,(day-11:day-1)); %high
data2 = stocksBasicData(5, : ,(day-11:day-1)); %low
data3 = stocksBasicData(2, : ,(day-11:day-1)); %close
data1 = squeeze(data1);
data2 = squeeze(data2);
data3 = squeeze(data3);

temp = - alphaPkg.delta(((data3 - data2) - (data1 - data3)) ./ (data3 - data2),9);
