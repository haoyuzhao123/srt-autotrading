...
data1 = stocksBasicData(1, : ,(day-8:day-1)); %open
data2 = stocksBasicData(2, : ,(day-8:day-1)); %close
data3 = stocksBasicData(6, : ,(day-8:day-1)); %volume
data4 = stocksBasicData(6, : ,(day-10:day-3)); %volume
data1 = squeeze(data1);
data2 = squeeze(data2);
data3 = squeeze(data3);
data4 = squeeze(data4);
temp = -1 * alphaPkg.Correlation(alphaPkg.Rank(log(data3) - log(data4)),alphaPkg.Rank((data2 - data1) ./ data1),6);
